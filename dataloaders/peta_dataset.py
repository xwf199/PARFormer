...
class petaDataset(Dataset):
    def __init__(self, split, args, transform=None, target_transform=None,known_labels=0,attr_group_dict=None,testing=False,n_groups=1):
        ...
        person_id = dataset_info.personid
        ...
        self.personid = [person_id[i].astype(np.int32) for i in self.img_idx]

        self.label = attr_label[self.img_idx]

        image_map_direction = restore_file('./dict_data_peta.pkl')
